...
module.exports = async (fastify, opts) => {
    ...
    fastify.post("/votes", webhook.hookListener(async (vote, req, res) => {
      ...
      let embed = new MessageEmbed()
       ...
       .setTimestamp()
       .setFooter({ text: "Infinity Vote Logger", iconURL: `${vote.userObj.avatar}` })

       await client.guilds.cache.get(config.guildID).channels.cache.get(config.voteLogs).send({ embeds: [embed] });
